...
namespace SyncToRetail
{
    public class Customer
    {
        ...
        public string TownClassify { get; set; }
        ...
        public string NoOfBillsOutstanding { get; set; }
        public string SegmentID { get; set; }
        public string AddCollDiscPercentage { get; set; }
        public string DefaultBeatID { get; set; }
        ...
        public string PreDefFlag { get; set; }
